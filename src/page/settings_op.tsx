          ...
          <Card title={t('panel.network')} bordered={false} size='small' style={cardStyle} headStyle={cardHeadStyle} bodyStyle={cardBodyStyle}>
            <Skeleton loading={loading} round active>
              ...
              >
                ...
                >
                  <InputNumber userRights={['admin', 'manager']} token={token} placeholder='ip.ip' controls={false} onChange={(value: any) => { }} onFocus={(e: any) => { }} />
                </Form.Item>
                <Form.Item
                  name="mask"
                  label={t('ip.mask')}
                  rules={[{ required: true, message: t('user.fill') }]}
                >
                  <InputNumber userRights={['admin', 'manager']} token={token} placeholder='ip.mask' controls={false} onChange={(value: any) => { }} onFocus={(e: any) => { }} />
                </Form.Item>
                <Form.Item
                  name="gw"
                  label={t('ip.gw')}
                  rules={[{ required: true, message: t('user.fill') }]}
                >
                  <InputNumber userRights={['admin', 'manager']} token={token} placeholder='ip.gw' controls={false} onChange={(value: any) => { }} onFocus={(e: any) => { }} />
                </Form.Item>
