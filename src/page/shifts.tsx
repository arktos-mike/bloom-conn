  ...
  const columns: ColumnsType<DataType> = [
    {
      ...
      dataIndex: 'shiftname',
      width: '10%',
      render: (_, record) => (<Input size="large" placeholder={t('shift.shift')} onUpdate={(value: any) => { record.shiftname = value; handleSave(record); }} onChange={(e: any) => { }} onFocus={(e: any) => { }} status={record.problemName ? 'error' : null} />),
    },
    {
