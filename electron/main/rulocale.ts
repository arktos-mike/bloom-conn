const locale = {
  ...
  "decimalSeparator": ",",
  "menu": {
    "title": "Система мониторинга парка ткацких станков",
    "close": "ЗАКРЫТЬ",
    "overview": "ОБЗОР",
    "settings": "НАСТРОЙКИ",
    "settingsNet": "КОНФИГУРАЦИЯ СЕТИ",
    "users": "АДМИНИСТРИРОВАНИЕ ПОЛЬЗОВАТЕЛЕЙ",
    "shifts": "УПРАВЛЕНИЕ СМЕНАМИ",
    "reminders": "НАПОМИНАНИЯ ТЕХ.ОБСЛУЖИВАНИЯ",
    "logs": "ЖУРНАЛЫ",
    "modelog": "ЖУРНАЛ ПУСКОВ-СТОПОВ",
    "userlog": "ЖУРНАЛ ДОСТУПА",
    "clothlog": "ЖУРНАЛ ОТРЕЗОВ",
  ...
  "stop": {
    "other": "прочее",
    "button": "нормальный останов по кнопке",
    "warp": "обрыв основы",
    "weft": "обрыв утка",
    "tool": "неисправность оборудования",
    "fabric": "выработка рулона ткани"
  },
  "shift": {
    "shift": "Смена",
    "days": "д",
  ...
  "notifications": {
    "none": "Нет текущих уведомлений",
    "descr": "Все активные уведомления подтверждены пользователем",
  ...
  "panel": {
    "main": "Рабочие параметры",
    "warpbeam": "Основа на навое",
    "roll": "Рулон ткани",
    "loom": "по станку",
    "weavers": "по ткачам",
    "shifts": "по сменам",
    ...
    "actions": "Действия",
    "network": "Сетевые настройки станков",
    "groups": "Настройки групп станков",
    "lifetime": "Статистическая информация станка за все время работы",
